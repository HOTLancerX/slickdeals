                ...
                <div className="flex flex-col md:flex-row gap-4">
                    ...
                    <div className="w-full md:w-1/2">
                        <div className="grid md:grid-cols-3 grid-cols-2 gap-3">
                            ...
                            <div className="flex items-center space-x-1 text-xs bg-white p-3 rounded-md shadow">
                                <span>
                                <svg width={30} height={30} className="text-secondary mr-2" viewBox="0 0 16 16" fill="currentColor" preserveAspectRatio="xMinYMin meet" role="img" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <div className="flex items-center space-x-1 text-xs bg-white p-3 rounded-md shadow">
                                <span>
                                <svg width={30} height={30} className="text-secondary mr-2" viewBox="0 0 16 14" fill="currentColor" preserveAspectRatio="xMinYMin meet" role="img" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <div className="flex items-center space-x-1 text-xs bg-white p-3 rounded-md shadow">
                                <span>
                                <svg width={30} height={30} className="text-secondary mr-2" version="1.1" fill="currentColor" viewBox="0 0 32 32" preserveAspectRatio="xMinYMin meet" role="img" xmlns="http://www.w3.org/2000/svg">
